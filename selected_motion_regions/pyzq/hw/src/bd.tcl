...
\
  ...
  connect_bd_net -net Net [get_bd_pins video_gray_live_0/motion_count_out] [get_bd_pins axi_gpio_3/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins v_axi4s_vid_out_0/aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins v_axi4s_vid_out_0/locked] [get_bd_ports locked] [get_bd_pins axi_gpio_2/gpio_io_i]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force
