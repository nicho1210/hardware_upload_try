...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler video_gray_live_prev_frame_RAM_2P_LUTRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_motion_count_out \
    op interface \
    ports { motion_count_out { O 32 vector } } \
} "
}
