...
set name gbt24_mul_32ns_32ns_64_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 26 \
			corename gbt24_CTRL_axilite \
			name gbt24_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gbt24_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 41
set RegSliceName gbt24_regslice_both
set RegSliceInstName gbt24_regslice_both_U
set CoreName ap_simcore_gbt24_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
